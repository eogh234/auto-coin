...
echo ""
echo " 📅 실행 스케줄 (평일 기준):"
echo "   ⏰ 09:05 KST — orchestrator.py (한국 주식 + 코인)"
echo "   🌙 23:20 KST — execute_us.py  (미국 주식)"
