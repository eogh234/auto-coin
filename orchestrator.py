...
class ProjectOrchestrator:
    ...
    def master_review(self, final_state: dict, portfolio_decision: dict):
        ...
        2. 100% 미국 주식 & 코인 전용: 주식 포트폴리오는 100% 미국 주식(market: NASD/NYSE/AMEX)으로만 운용하며, 만약 한국 주식(market: KR)이 포함되었을 경우 승인하지 마십시오.
        3. 리스크 우선: 미국 방어 자산(SGOV/TLT/SPY 등) 및 코인 테더(USDT) 비중이 확보되었는지 확인한다.
